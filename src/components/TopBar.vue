...
<!--        </button>-->
        ...
        <!--            &lt;!&ndash; Card Search Content &ndash;&gt;-->
        ...
        <!--                <a class="dropdown-item my-2" href="./index.html">-->
        <!--                  <div class="media align-items-center">-->
        <!--                    <img class="avatar avatar-xs avatar-circle mr-2" src="./img/160x160/img10.jpg" alt="Image Description">-->
        <!--                    <div class="media-body text-truncate">-->
        ...
        <!--                <a class="dropdown-item my-2" href="./index.html">-->
        <!--                  <div class="media align-items-center">-->
        <!--                    <img class="avatar avatar-xs avatar-circle mr-2" src="./img/160x160/img3.jpg" alt="Image Description">-->
        <!--                    <div class="media-body text-truncate">-->
        ...
        <!--            </div>-->
        <!--            &lt;!&ndash; End Card Search Content &ndash;&gt;-->
        <!--          </form>-->
        <!--        </div>-->
        <!-- End Search Form -->
      </div>
...
<!--                                  <img class="avatar-img" src="../../public/img/160x160/img3.jpg" alt="Image Description">-->
<!--                                </div>-->
<!--                              </div>-->
<!--                            </div>-->
<!--                            <div class="col ml-n3">-->
...
<!--                                </div>-->
<!--                                <div class="avatar avatar-sm avatar-circle">-->
<!--                                  <img class="avatar-img" src="../../public/img/160x160/img10.jpg" alt="Image Description">-->
<!--                                </div>-->
<!--                              </div>-->
<!--                            </div>-->
<!--                            <div class="col ml-n3">-->
...
<!--                                </div>-->
<!--                                <div class="avatar avatar-sm avatar-circle">-->
<!--                                  <img class="avatar-img" src="../../public/svg/brands/google.svg" alt="Image Description">-->
<!--                                </div>-->
<!--                              </div>-->
<!--                            </div>-->
<!--                            <div class="col ml-n3">-->
...
<!--                                </div>-->
<!--                                <div class="avatar avatar-sm avatar-circle">-->
<!--                                  <img class="avatar-img" src="../../public/img/160x160/img7.jpg" alt="Image Description">-->
<!--                                </div>-->
<!--                              </div>-->
<!--                            </div>-->
<!--                            <div class="col ml-n3">-->
...
<!--                                </div>-->
<!--                                <div class="avatar avatar-sm avatar-circle">-->
<!--                                  <img class="avatar-img" src="../../public/img/160x160/img5.jpg" alt="Image Description">-->
<!--                                </div>-->
<!--                              </div>-->
<!--                            </div>-->
<!--                            <div class="col ml-n3">-->
...
<!--                                </div>-->
<!--                                <div class="avatar avatar-sm avatar-circle">-->
<!--                                  <img class="avatar-img" src="../../public/img/160x160/img8.jpg" alt="Image Description">-->
<!--                                </div>-->
<!--                              </div>-->
<!--                            </div>-->
<!--                            <div class="col ml-n3">-->
...
<!--              <div id="appsDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right navbar-dropdown-menu hs-unfold-hidden hs-unfold-content-initialized hs-unfold-css-animation animated" style="width: 25rem; animation-duration: 300ms;" data-hs-target-height="450" data-hs-unfold-content="" data-hs-unfold-content-animation-in="slideInUp" data-hs-unfold-content-animation-out="fadeOut">-->
<!--                &lt;!&ndash; Header &ndash;&gt;-->
<!--                <div class="card-header">-->
...
<!--                      <div class="media align-items-center">-->
<!--                      <span class="mr-3">-->
<!--                        <img class="avatar avatar-xs avatar-4by3" src="../../public/svg/brands/atlassian.svg" alt="Image Description">-->
<!--                      </span>-->
<!--                        <div class="media-body text-truncate">-->
...
<!--                      <div class="media align-items-center">-->
<!--                      <span class="mr-3">-->
<!--                        <img class="avatar avatar-xs avatar-4by3" src="../../public/svg/brands/slack.svg" alt="Image Description">-->
<!--                      </span>-->
<!--                        <div class="media-body text-truncate">-->
...
<!--                      <div class="media align-items-center">-->
<!--                      <span class="mr-3">-->
<!--                        <img class="avatar avatar-xs avatar-4by3" src="../../public/svg/brands/google-webdev.svg" alt="Image Description">-->
<!--                      </span>-->
<!--                        <div class="media-body text-truncate">-->
...
<!--                      <div class="media align-items-center">-->
<!--                      <span class="mr-3">-->
<!--                        <img class="avatar avatar-xs avatar-4by3" src="../../public/svg/brands/frontapp.svg" alt="Image Description">-->
<!--                      </span>-->
<!--                        <div class="media-body text-truncate">-->
...
<!--                      <div class="media align-items-center">-->
<!--                      <span class="mr-3">-->
<!--                        <img class="avatar avatar-xs avatar-4by3" src="../../public/svg/illustrations/review-rating-shield.svg" alt="Image Description">-->
<!--                      </span>-->
<!--                        <div class="media-body text-truncate">-->
